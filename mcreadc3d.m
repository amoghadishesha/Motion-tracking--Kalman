...
d.type = 'MoCap data';        
d.filename = fn;
d.nFrames = data.Header.EndVideoFrame-data.Header.FirstVideoFrame+1;
d.fFrame = data.Header.FirstVideoFrame;
d.nCameras = 0;
...
if data.Header.EndVideoFrame ~= size(d.data, 1) %BBFIX20141202 Optitrack apparently has issues with this.
